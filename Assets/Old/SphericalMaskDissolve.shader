Shader "Custom/SphericalMaskDissolve"
{
	Properties{
		...
		SubShader{
			...
			float3 _GLOBALIMaskPosition;
			half _GLOBALIMaskRadius;
			half _GLOBALIMaskSoftness;
			...
			void surf(Input IN, inout SurfaceOutputStandard o) {
				...
				half dist = distance(_GLOBALIMaskPosition, IN.worldPos);
				half sphere = 1 - saturate((dist - _GLOBALIMaskRadius) / _GLOBALIMaskSoftness);
				clip(sphere - 0.1);
